...
<head>
    ...
    <!-- Title Tag  -->
    <title>Courses - House of Daniel Fashions Academy</title>
...
<body id="bg">
    ...
    <div id="page" class="site boxed-layout">
        ...
        <!-- Breadcrumb -->
        <div class="breadcrumbs overlay" style="background-image:url('img/Slider1.jpg')">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="section-title  style2 text-center">
                            <div class="section-top">
                                <h1><span>Professional Courses</span><b>
                                        <font color=black>Our Courses</font>
                                    </b></h1>
                                <h4>A Collection of our Professional Courses Just for You &amp; support..</h4>
                            </div>
                            <div class="section-bottom">
                                <div class="text-style-two">
                                    <p>We are here to help you build your career and teach you the simplest way to bring
                                        your vision to reality, enroll for our courses today!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-service">
                            ...
                            <div class="service-content">
                                <h4><a  target="_blank" href="/course-courtesy-and-bra-making">
                                        <font color=black>Courtesy and Bra Making</font>
                                    </a></h4>
                                <p>This course covers techniques you can apply in Readymade garments and Commercial
                                    patterns. Readymade garments generally requires minor and major... </p>
                                <a class="btn" target="_blank"  href="/course-courtesy-and-bra-making"><i
                                        class="fa fa-arrow-circle-o-right"></i>View Course</a>
                            </div>
                        </div>
                        <!--/ End Single Course -->
                    ...
                    {{-- <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-service">
                            ...
                            <div class="service-content">
                                <h4><a target="_blank"  href="service-marketing.html">
                                        <font color=black>Womenwear and Skirts</font>
                                    </a></h4>
                                <p>This course will give you basic knowledge of the Principles of Garment Construction.
                                    We thrive on giving our students professional industry...</p>
                                <a class="btn" target="_blank"  href="service-marketing.html"><i
                                        class="fa fa-arrow-circle-o-right"></i>View Course</a>
                            </div>
                        </div>
                        <!--/ End Single Course-->
